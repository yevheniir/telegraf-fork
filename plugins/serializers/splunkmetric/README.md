...
You can either use `[global_tags]` or using a more advanced configuration as documented [here](https://github.com/yevheniir/telegraf-fork/blob/master/docs/CONFIGURATION.md).
