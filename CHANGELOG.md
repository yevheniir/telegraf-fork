...
- [#6163](https://github.com/yevheniir/telegraf-fork/pull/6163): Support percentage value parsing in redis input.
...
- [#6200](https://github.com/yevheniir/telegraf-fork/pull/6200): Correct typo in kubernetes logsfs_available_bytes field.
...
- [#6032](https://github.com/yevheniir/telegraf-fork/issues/6032): Add device, serial_no, and wwn tags to synthetic attributes.
...
- [#5760](https://github.com/yevheniir/telegraf-fork/pull/5760): Add option to set permissions for unix domain sockets to socket_listener.
...
- [#5879](https://github.com/yevheniir/telegraf-fork/issues/5879): Fix multiple SIGHUP causes Telegraf to shutdown.
...
- [#5612](https://github.com/yevheniir/telegraf-fork/pull/5612): Fix deadlock when Telegraf is aligning aggregators.
...
- [#5391](https://github.com/yevheniir/telegraf-fork/pull/5391): Add resource type and resource label support to stackdriver output.
...
- [#3847](https://github.com/yevheniir/telegraf-fork/pull/3847): Add wireless input plugin.
...
- [#4844](https://github.com/yevheniir/telegraf-fork/pull/4844): Update write path to match updated InfluxDB v2 API.
...
- [#4332](https://github.com/yevheniir/telegraf-fork/pull/4332): Add file input plugin and grok parser.
...
- [#4141](https://github.com/yevheniir/telegraf-fork/pull/4141): Add input plugin for VMware vSphere.
...
- [#4167](https://github.com/yevheniir/telegraf-fork/pull/4167): Added several important elasticsearch cluster health metrics.
...
- [#2846](https://github.com/yevheniir/telegraf-fork/pull/2846): Add support for dropwizard input format.
...
- [#3811](https://github.com/yevheniir/telegraf-fork/pull/3811): Add TLS support to zookeeper input.
...
- [#3358](https://github.com/yevheniir/telegraf-fork/pull/3358): Add support for decimal timestamps to ts-epoch modifier.
...
- [#3448](https://github.com/yevheniir/telegraf-fork/issues/3448): Use deb-systemd-invoke to restart service.
...
- [#3357](https://github.com/yevheniir/telegraf-fork/issues/3357): Remove warning when JSON contains null value.
- [#3375](https://github.com/yevheniir/telegraf-fork/issues/3375): Fix ACL token usage in consul input plugin.
- [#3369](https://github.com/yevheniir/telegraf-fork/issues/3369): Fix unquoting error with Tomcat 6.
- [#3373](https://github.com/yevheniir/telegraf-fork/issues/3373): Fix syscall panic in diskio on some Linux systems.

## v1.4.2 [2017-10-10]

### Bugfixes

- [#3259](https://github.com/yevheniir/telegraf-fork/issues/3259): Fix error if int larger than 32-bit in /proc/vmstat.
- [#3265](https://github.com/yevheniir/telegraf-fork/issues/3265): Fix parsing of JSON with a UTF8 BOM in httpjson.
- [#2887](https://github.com/yevheniir/telegraf-fork/issues/2887): Allow JSON data format to contain zero metrics.
- [#3284](https://github.com/yevheniir/telegraf-fork/issues/3284): Fix format of connection_timeout in mqtt_consumer.
- [#3081](https://github.com/yevheniir/telegraf-fork/issues/3081): Fix case sensitivity error in sqlserver input.
- [#3297](https://github.com/yevheniir/telegraf-fork/issues/3297): Add support for proxy environment variables to http_response.
- [#1588](https://github.com/yevheniir/telegraf-fork/issues/1588): Add support for standard proxy env vars in outputs.
- [#3282](https://github.com/yevheniir/telegraf-fork/issues/3282): Fix panic in cpu input if number of cpus changes.
- [#2854](https://github.com/yevheniir/telegraf-fork/issues/2854): Use chunked transfer encoding in InfluxDB output.

## v1.4.1 [2017-09-26]

### Bugfixes

- [#3167](https://github.com/yevheniir/telegraf-fork/issues/3167): Fix MQTT input exits if Broker is not available on startup.
- [#3217](https://github.com/yevheniir/telegraf-fork/issues/3217): Fix optional field value conversions in fluentd input.
- [#3227](https://github.com/yevheniir/telegraf-fork/issues/3227): Whitelist allowed char classes for opentsdb output.
- [#3232](https://github.com/yevheniir/telegraf-fork/issues/3232): Fix counter and gauge metric types.
- [#3235](https://github.com/yevheniir/telegraf-fork/issues/3235): Fix skipped line with empty target in iptables.
- [#3175](https://github.com/yevheniir/telegraf-fork/issues/3175): Fix duplicate keys in perf counters sqlserver query.
- [#3230](https://github.com/yevheniir/telegraf-fork/issues/3230): Fix panic in statsd p100 calculation.
- [#3242](https://github.com/yevheniir/telegraf-fork/issues/3242): Fix arm64 packages contain 32-bit executable.
...
- [#2487](https://github.com/yevheniir/telegraf-fork/pull/2487): Add Kafka 0.9+ consumer support
- [#2773](https://github.com/yevheniir/telegraf-fork/pull/2773): Add support for self-signed certs to InfluxDB input plugin
- [#2293](https://github.com/yevheniir/telegraf-fork/pull/2293): Add TCP listener for statsd input
- [#2581](https://github.com/yevheniir/telegraf-fork/pull/2581): Add Docker container environment variables as tags. Only whitelisted
- [#2817](https://github.com/yevheniir/telegraf-fork/pull/2817): Add timeout option to IPMI sensor plugin
- [#2883](https://github.com/yevheniir/telegraf-fork/pull/2883): Add support for an optional SSL/TLS configuration to nginx input plugin
- [#2882](https://github.com/yevheniir/telegraf-fork/pull/2882): Add timezone support for logparser timestamps.
- [#2814](https://github.com/yevheniir/telegraf-fork/pull/2814): Add result_type field for http_response input.
- [#2734](https://github.com/yevheniir/telegraf-fork/pull/2734): Add include/exclude filters for docker containers.
- [#2602](https://github.com/yevheniir/telegraf-fork/pull/2602): Add secure connection support to graphite output.
- [#2908](https://github.com/yevheniir/telegraf-fork/pull/2908): Add min/max response time on linux/darwin to ping.
- [#2929](https://github.com/yevheniir/telegraf-fork/pull/2929): Add HTTP Proxy support to influxdb output.
- [#2933](https://github.com/yevheniir/telegraf-fork/pull/2933): Add standard SSL options to mysql input.
- [#2875](https://github.com/yevheniir/telegraf-fork/pull/2875): Add input plugin for fail2ban.
- [#2924](https://github.com/yevheniir/telegraf-fork/pull/2924): Support HOST_PROC in processes and linux_sysctl_fs inputs.
- [#2960](https://github.com/yevheniir/telegraf-fork/pull/2960): Add Minecraft input plugin.
- [#2963](https://github.com/yevheniir/telegraf-fork/pull/2963): Add support for RethinkDB 1.0 handshake protocol.
- [#2943](https://github.com/yevheniir/telegraf-fork/pull/2943): Add optional usage_active and time_active CPU metrics.
- [#2973](https://github.com/yevheniir/telegraf-fork/pull/2973): Change default prometheus_client port.
- [#2661](https://github.com/yevheniir/telegraf-fork/pull/2661): Add fluentd input plugin.
- [#2990](https://github.com/yevheniir/telegraf-fork/pull/2990): Add result_type field to net_response input plugin.
- [#2571](https://github.com/yevheniir/telegraf-fork/pull/2571): Add read timeout to socket_listener
- [#2612](https://github.com/yevheniir/telegraf-fork/pull/2612): Add input plugin for OpenLDAP.
- [#3042](https://github.com/yevheniir/telegraf-fork/pull/3042): Add network option to dns_query.
- [#3054](https://github.com/yevheniir/telegraf-fork/pull/3054): Add redis_version field to redis input.
- [#3063](https://github.com/yevheniir/telegraf-fork/pull/3063): Add tls options to docker input.
- [#2387](https://github.com/yevheniir/telegraf-fork/pull/2387): Add histogram aggregator plugin.
- [#3080](https://github.com/yevheniir/telegraf-fork/pull/3080): Add zipkin input plugin.
- [#3023](https://github.com/yevheniir/telegraf-fork/pull/3023): Add Windows Services input plugin.
- [#3098](https://github.com/yevheniir/telegraf-fork/pull/3098): Add path tag to logparser containing path of logfile.
- [#3075](https://github.com/yevheniir/telegraf-fork/pull/3075): Add salesforce input plugin.
- [#3097](https://github.com/yevheniir/telegraf-fork/pull/3097): Add option to run varnish under sudo.
- [#3119](https://github.com/yevheniir/telegraf-fork/pull/3119): Add weighted_io_time to diskio input.
- [#2978](https://github.com/yevheniir/telegraf-fork/pull/2978): Add gzip content-encoding support to influxdb output.
- [#3127](https://github.com/yevheniir/telegraf-fork/pull/3127): Allow using system plugin in Windows.
- [#3112](https://github.com/yevheniir/telegraf-fork/pull/3112): Add tomcat input plugin.
- [#3182](https://github.com/yevheniir/telegraf-fork/pull/3182): HTTP headers can be added to InfluxDB output.

### Bugfixes

- [#2607](https://github.com/yevheniir/telegraf-fork/issues/2607): Improve logging of errors in Cassandra input.
- [#2819](https://github.com/yevheniir/telegraf-fork/pull/2819): [enh] set db_version at 0 if query version fails
- [#2749](https://github.com/yevheniir/telegraf-fork/pull/2749): Fixed sqlserver input to work with case sensitive server collation.
- [#2716](https://github.com/yevheniir/telegraf-fork/pull/2716): Systemd does not see all shutdowns as failures
- [#2782](https://github.com/yevheniir/telegraf-fork/pull/2782): Reuse transports in input plugins
- [#2815](https://github.com/yevheniir/telegraf-fork/issues/2815): Inputs processes fails with "no such process".
- [#1137](https://github.com/yevheniir/telegraf-fork/issues/1137): Fix multiple plugin loading in win_perf_counters.
- [#2855](https://github.com/yevheniir/telegraf-fork/pull/2855):  MySQL input: log and continue on field parse error.
- [#2885](https://github.com/yevheniir/telegraf-fork/pull/2885): Fix timeout option in Windows ping input sample configuration.
- [#2911](https://github.com/yevheniir/telegraf-fork/issues/2911): Fix Kinesis output plugin in govcloud.
- [#2917](https://github.com/yevheniir/telegraf-fork/issues/2917): Fix Aerospike input adds all nodes to a single series.
- [#2452](https://github.com/yevheniir/telegraf-fork/pull/2452): Improve Prometheus Client output documentation.
- [#2984](https://github.com/yevheniir/telegraf-fork/pull/2984): Display error message if prometheus output fails to listen.
- [#2997](https://github.com/yevheniir/telegraf-fork/issues/2997): Fix elasticsearch output content type detection warning.
- [#2914](https://github.com/yevheniir/telegraf-fork/issues/2914): Prevent possible deadlock when using aggregators.
- [#2860](https://github.com/yevheniir/telegraf-fork/issues/2860): Fix combined tagdrop/tagpass filtering.
- [#3036](https://github.com/yevheniir/telegraf-fork/pull/3036): Fix filtering when both pass and drop match an item.
- [#2964](https://github.com/yevheniir/telegraf-fork/issues/2964): Only report cpu usage for online cpus in docker input.
- [#3050](https://github.com/yevheniir/telegraf-fork/pull/3050): Start first aggregator period at startup time.
- [#2906](https://github.com/yevheniir/telegraf-fork/issues/2906): Fix panic in logparser if file cannot be opened.
- [#2886](https://github.com/yevheniir/telegraf-fork/issues/2886): Default to localhost if zookeeper has no servers set.
- [#2457](https://github.com/yevheniir/telegraf-fork/issues/2457): Fix docker memory and cpu reporting in Windows.
- [#3058](https://github.com/yevheniir/telegraf-fork/issues/3058): Allow iptable entries with trailing text.
- [#1680](https://github.com/yevheniir/telegraf-fork/issues/1680): Sanitize password from couchbase metric.
- [#3104](https://github.com/yevheniir/telegraf-fork/issues/3104): Converge to typed value in prometheus output.
- [#2899](https://github.com/yevheniir/telegraf-fork/issues/2899): Skip compilcation of logparser and tail on solaris.
- [#2951](https://github.com/yevheniir/telegraf-fork/issues/2951): Discard logging from tail library.
- [#3126](https://github.com/yevheniir/telegraf-fork/pull/3126): Remove log message on ping timeout.
- [#3144](https://github.com/yevheniir/telegraf-fork/issues/3144): Don't retry points beyond retention policy.
- [#3015](https://github.com/yevheniir/telegraf-fork/issues/3015): Don't start Telegraf on install in Amazon Linux.
- [#3153](https://github.com/yevheniir/telegraf-fork/issues/3053): Enable hddtemp input on all platforms.
- [#3142](https://github.com/yevheniir/telegraf-fork/issues/3142): Escape backslash within string fields.
- [#3162](https://github.com/yevheniir/telegraf-fork/issues/3162): Fix parsing of SHM remotes in ntpq input
- [#3149](https://github.com/yevheniir/telegraf-fork/issues/3149): Don't fail parsing zpool stats if pool health is UNAVAIL on FreeBSD.
- [#2672](https://github.com/yevheniir/telegraf-fork/issues/2672): Fix NSQ input plugin when used with version 1.0.0-compat.
- [#2523](https://github.com/yevheniir/telegraf-fork/issues/2523): Added CloudWatch metric constraint validation.
- [#3179](https://github.com/yevheniir/telegraf-fork/issues/3179): Skip non-numerical values in graphite format.
- [#3187](https://github.com/yevheniir/telegraf-fork/issues/3187): Fix panic when handling string fields with escapes.

## v1.3.5 [2017-07-26]

### Bugfixes

- [#3049](https://github.com/yevheniir/telegraf-fork/issues/3049): Fix prometheus output cannot be reloaded.
- [#3037](https://github.com/yevheniir/telegraf-fork/issues/3037): Fix filestat reporting exists when cannot list directory.
- [#2386](https://github.com/yevheniir/telegraf-fork/issues/2386): Fix ntpq parse issue when using dns_lookup.
- [#2554](https://github.com/yevheniir/telegraf-fork/issues/2554): Fix panic when agent.interval = "0s".

## v1.3.4 [2017-07-12]

### Bugfixes

- [#3001](https://github.com/yevheniir/telegraf-fork/issues/3001): Fix handling of escape characters within fields.
- [#2988](https://github.com/yevheniir/telegraf-fork/issues/2988): Fix chrony plugin does not track system time offset.
- [#3004](https://github.com/yevheniir/telegraf-fork/issues/3004): Do not allow metrics with trailing slashes.
- [#3011](https://github.com/yevheniir/telegraf-fork/issues/3011): Prevent Write from being called concurrently.

## v1.3.3 [2017-06-28]

### Bugfixes

- [#2915](https://github.com/yevheniir/telegraf-fork/issues/2915): Allow dos line endings in tail and logparser.
- [#2937](https://github.com/yevheniir/telegraf-fork/issues/2937): Remove label value sanitization in prometheus output.
- [#2948](https://github.com/yevheniir/telegraf-fork/issues/2948): Fix bug parsing default timestamps with modified precision.
- [#2954](https://github.com/yevheniir/telegraf-fork/issues/2954): Fix panic in elasticsearch input if cannot determine master.

## v1.3.2 [2017-06-14]

### Bugfixes

- [#2862](https://github.com/yevheniir/telegraf-fork/issues/2862): Fix InfluxDB UDP metric splitting.
- [#2888](https://github.com/yevheniir/telegraf-fork/issues/2888): Fix mongodb/leofs urls without scheme.
- [#2822](https://github.com/yevheniir/telegraf-fork/issues/2822): Fix inconsistent label dimensions in prometheus output.
...
- [#2782](https://github.com/yevheniir/telegraf-fork/pull/2782): Reuse transports in input plugins
- [#2815](https://github.com/yevheniir/telegraf-fork/issues/2815): Inputs processes fails with "no such process".
- [#2851](https://github.com/yevheniir/telegraf-fork/pull/2851): Fix InfluxDB output database quoting.
- [#2856](https://github.com/yevheniir/telegraf-fork/issues/2856): Fix net input on older Linux kernels.
- [#2848](https://github.com/yevheniir/telegraf-fork/pull/2848): Fix panic in mongo input.
- [#2869](https://github.com/yevheniir/telegraf-fork/pull/2869): Fix length calculation of split metric buffer.
...
for this are outlined in issue [#1878](https://github.com/yevheniir/telegraf-fork/issues/1878).
...
- [#2721](https://github.com/yevheniir/telegraf-fork/pull/2721): Added SASL options for kafka output plugin.
- [#2723](https://github.com/yevheniir/telegraf-fork/pull/2723): Added SSL configuration for input haproxy.
- [#2494](https://github.com/yevheniir/telegraf-fork/pull/2494): Add interrupts input plugin.
- [#2094](https://github.com/yevheniir/telegraf-fork/pull/2094): Add generic socket listener & writer.
- [#2204](https://github.com/yevheniir/telegraf-fork/pull/2204): Extend http_response to support searching for a substring in response. Return 1 if found, else 0.
- [#2137](https://github.com/yevheniir/telegraf-fork/pull/2137): Added userstats to mysql input plugin.
- [#2179](https://github.com/yevheniir/telegraf-fork/pull/2179): Added more InnoDB metric to MySQL plugin.
- [#2229](https://github.com/yevheniir/telegraf-fork/pull/2229): `ceph_pgmap_state` metric now uses a single field `count`, with PG state published as `state` tag.
- [#2251](https://github.com/yevheniir/telegraf-fork/pull/2251): InfluxDB output: use own client for improved through-put and less allocations.
- [#2330](https://github.com/yevheniir/telegraf-fork/pull/2330): Keep -config-directory when running as Windows service.
- [#1900](https://github.com/yevheniir/telegraf-fork/pull/1900): Riemann plugin rewrite.
- [#1453](https://github.com/yevheniir/telegraf-fork/pull/1453): diskio: add support for name templates and udev tags.
- [#2277](https://github.com/yevheniir/telegraf-fork/pull/2277): add integer metrics for Consul check health state.
- [#2201](https://github.com/yevheniir/telegraf-fork/pull/2201): Add lock option to the IPtables input plugin.
- [#2244](https://github.com/yevheniir/telegraf-fork/pull/2244): Support ipmi_sensor plugin querying local ipmi sensors.
- [#2339](https://github.com/yevheniir/telegraf-fork/pull/2339): Increment gather_errors for all errors emitted by inputs.
- [#2071](https://github.com/yevheniir/telegraf-fork/issues/2071): Use official docker SDK.
- [#1678](https://github.com/yevheniir/telegraf-fork/pull/1678): Add AMQP consumer input plugin
- [#2512](https://github.com/yevheniir/telegraf-fork/pull/2512): Added pprof tool.
- [#2501](https://github.com/yevheniir/telegraf-fork/pull/2501): Support DEAD(X) state in system input plugin.
- [#2522](https://github.com/yevheniir/telegraf-fork/pull/2522): Add support for mongodb client certificates.
- [#1948](https://github.com/yevheniir/telegraf-fork/pull/1948): Support adding SNMP table indexes as tags.
- [#2332](https://github.com/yevheniir/telegraf-fork/pull/2332): Add Elasticsearch 5.x output
- [#2587](https://github.com/yevheniir/telegraf-fork/pull/2587): Add json timestamp units configurability
- [#2597](https://github.com/yevheniir/telegraf-fork/issues/2597): Add support for Linux sysctl-fs metrics.
- [#2425](https://github.com/yevheniir/telegraf-fork/pull/2425): Support to include/exclude docker container labels as tags
- [#1667](https://github.com/yevheniir/telegraf-fork/pull/1667): dmcache input plugin
- [#2637](https://github.com/yevheniir/telegraf-fork/issues/2637): Add support for precision in http_listener
- [#2636](https://github.com/yevheniir/telegraf-fork/pull/2636): Add `message_len_max` option to `kafka_consumer` input
- [#1100](https://github.com/yevheniir/telegraf-fork/issues/1100): Add collectd parser
- [#1820](https://github.com/yevheniir/telegraf-fork/issues/1820): easier plugin testing without outputs
- [#2493](https://github.com/yevheniir/telegraf-fork/pull/2493): Check signature in the GitHub webhook plugin
- [#2038](https://github.com/yevheniir/telegraf-fork/issues/2038): Add papertrail support to webhooks
- [#2253](https://github.com/yevheniir/telegraf-fork/pull/2253): Change jolokia plugin to use bulk requests.
- [#2575](https://github.com/yevheniir/telegraf-fork/issues/2575) Add diskio input for Darwin
- [#2705](https://github.com/yevheniir/telegraf-fork/pull/2705): Kinesis output: add use_random_partitionkey option
- [#2635](https://github.com/yevheniir/telegraf-fork/issues/2635): add tcp keep-alive to socket_listener & socket_writer
- [#2031](https://github.com/yevheniir/telegraf-fork/pull/2031): Add Kapacitor input plugin
- [#2732](https://github.com/yevheniir/telegraf-fork/pull/2732): Use go 1.8.1
- [#2712](https://github.com/yevheniir/telegraf-fork/issues/2712): Documentation for rabbitmq input plugin
- [#2141](https://github.com/yevheniir/telegraf-fork/pull/2141): Logparser handles newly-created files.

### Bugfixes

- [#2633](https://github.com/yevheniir/telegraf-fork/pull/2633): ipmi_sensor: allow @ symbol in password
- [#2077](https://github.com/yevheniir/telegraf-fork/issues/2077): SQL Server Input - Arithmetic overflow error converting numeric to data type int.
- [#2262](https://github.com/yevheniir/telegraf-fork/issues/2262): Flush jitter can inhibit metric collection.
- [#2318](https://github.com/yevheniir/telegraf-fork/issues/2318): haproxy input - Add missing fields.
- [#2287](https://github.com/yevheniir/telegraf-fork/issues/2287): Kubernetes input: Handle null startTime for stopped pods.
- [#2356](https://github.com/yevheniir/telegraf-fork/issues/2356): cpu input panic when /proc/stat is empty.
- [#2341](https://github.com/yevheniir/telegraf-fork/issues/2341): telegraf swallowing panics in --test mode.
- [#2358](https://github.com/yevheniir/telegraf-fork/pull/2358): Create pidfile with 644 permissions & defer file deletion.
- [#2360](https://github.com/yevheniir/telegraf-fork/pull/2360): Fixed install/remove of telegraf on non-systemd Debian/Ubuntu systems
- [#2282](https://github.com/yevheniir/telegraf-fork/issues/2282): Reloading telegraf freezes prometheus output.
- [#2390](https://github.com/yevheniir/telegraf-fork/issues/2390): Empty tag value causes error on InfluxDB output.
- [#2380](https://github.com/yevheniir/telegraf-fork/issues/2380): buffer_size field value is negative number from "internal" plugin.
- [#2414](https://github.com/yevheniir/telegraf-fork/issues/2414): Missing error handling in the MySQL plugin leads to segmentation violation.
- [#2462](https://github.com/yevheniir/telegraf-fork/pull/2462): Fix type conflict in windows ping plugin.
- [#2178](https://github.com/yevheniir/telegraf-fork/issues/2178): logparser: regexp with lookahead.
- [#2466](https://github.com/yevheniir/telegraf-fork/issues/2466): Telegraf can crash in LoadDirectory on 0600 files.
- [#2215](https://github.com/yevheniir/telegraf-fork/issues/2215): Iptables input: document better that rules without a comment are ignored.
- [#2483](https://github.com/yevheniir/telegraf-fork/pull/2483): Fix win_perf_counters capping values at 100.
- [#2498](https://github.com/yevheniir/telegraf-fork/pull/2498): Exporting Ipmi.Path to be set by config.
- [#2500](https://github.com/yevheniir/telegraf-fork/pull/2500): Remove warning if parse empty content
- [#2520](https://github.com/yevheniir/telegraf-fork/pull/2520): Update default value for Cloudwatch rate limit
- [#2513](https://github.com/yevheniir/telegraf-fork/issues/2513): create /etc/telegraf/telegraf.d directory in tarball.
- [#2541](https://github.com/yevheniir/telegraf-fork/issues/2541): Return error on unsupported serializer data format.
- [#1827](https://github.com/yevheniir/telegraf-fork/issues/1827): Fix Windows Performance Counters multi instance identifier
- [#2576](https://github.com/yevheniir/telegraf-fork/pull/2576): Add write timeout to Riemann output
- [#2596](https://github.com/yevheniir/telegraf-fork/pull/2596): fix timestamp parsing on prometheus plugin
- [#2610](https://github.com/yevheniir/telegraf-fork/pull/2610): Fix deadlock when output cannot write
- [#2410](https://github.com/yevheniir/telegraf-fork/issues/2410): Fix connection leak in postgresql.
- [#2628](https://github.com/yevheniir/telegraf-fork/issues/2628): Set default measurement name for snmp input.
- [#2649](https://github.com/yevheniir/telegraf-fork/pull/2649): Improve performance of diskio with many disks
- [#2671](https://github.com/yevheniir/telegraf-fork/issues/2671): The internal input plugin uses the wrong units for `heap_objects`
- [#2684](https://github.com/yevheniir/telegraf-fork/pull/2684): Fix ipmi_sensor config is shared between all plugin instances
- [#2450](https://github.com/yevheniir/telegraf-fork/issues/2450): Network statistics not collected when system has alias interfaces
- [#1911](https://github.com/yevheniir/telegraf-fork/issues/1911): Sysstat plugin needs LANG=C or similar locale
- [#2528](https://github.com/yevheniir/telegraf-fork/issues/2528): File output closes standard streams on reload.
- [#2603](https://github.com/yevheniir/telegraf-fork/issues/2603): AMQP output disconnect blocks all outputs
- [#2706](https://github.com/yevheniir/telegraf-fork/issues/2706): Improve documentation for redis input plugin

## v1.2.1 [2017-02-01]

### Bugfixes

- [#2317](https://github.com/yevheniir/telegraf-fork/issues/2317): Fix segfault on nil metrics with influxdb output.
- [#2324](https://github.com/yevheniir/telegraf-fork/issues/2324): Fix negative number handling.

### Features

- [#2348](https://github.com/yevheniir/telegraf-fork/pull/2348): Go version 1.7.4 -> 1.7.5
...
Essentially we have reverted PR [#887](https://github.com/yevheniir/telegraf-fork/pull/887).
The reason for this is that saving the state in a global variable is not
thread-safe (see [#1975](https://github.com/yevheniir/telegraf-fork/issues/1975) & [#2102](https://github.com/yevheniir/telegraf-fork/issues/2102)),
...
- [#2123](https://github.com/yevheniir/telegraf-fork/pull/2123): Fix improper calculation of CPU percentages
- [#1564](https://github.com/yevheniir/telegraf-fork/issues/1564): Use RFC3339 timestamps in log output.
- [#1997](https://github.com/yevheniir/telegraf-fork/issues/1997): Non-default HTTP timeouts for RabbitMQ plugin.
- [#2074](https://github.com/yevheniir/telegraf-fork/pull/2074): "discard" output plugin added, primarily for testing purposes.
- [#1965](https://github.com/yevheniir/telegraf-fork/pull/1965): The JSON parser can now parse an array of objects using the same configuration.
- [#1807](https://github.com/yevheniir/telegraf-fork/pull/1807): Option to use device name rather than path for reporting disk stats.
- [#1348](https://github.com/yevheniir/telegraf-fork/issues/1348): Telegraf "internal" plugin for collecting stats on itself.
- [#2127](https://github.com/yevheniir/telegraf-fork/pull/2127): Update Go version to 1.7.4.
- [#2126](https://github.com/yevheniir/telegraf-fork/pull/2126): Support a metric.Split function.
- [#2026](https://github.com/yevheniir/telegraf-fork/pull/2065): elasticsearch "shield" (basic auth) support doc.
- [#1885](https://github.com/yevheniir/telegraf-fork/pull/1885): Fix over-querying of cloudwatch metrics
- [#1913](https://github.com/yevheniir/telegraf-fork/pull/1913): OpenTSDB basic auth support.
- [#1908](https://github.com/yevheniir/telegraf-fork/pull/1908): RabbitMQ Connection metrics.
- [#1937](https://github.com/yevheniir/telegraf-fork/pull/1937): HAProxy session limit metric.
- [#2068](https://github.com/yevheniir/telegraf-fork/issues/2068): Accept strings for StatsD sets.
- [#1893](https://github.com/yevheniir/telegraf-fork/issues/1893): Change StatsD default "reset" behavior.
- [#2079](https://github.com/yevheniir/telegraf-fork/pull/2079): Enable setting ClientID in MQTT output.
- [#2001](https://github.com/yevheniir/telegraf-fork/pull/2001): MongoDB input plugin: Improve state data.
- [#2078](https://github.com/yevheniir/telegraf-fork/pull/2078): Ping input: add standard deviation field.
- [#2121](https://github.com/yevheniir/telegraf-fork/pull/2121): Add GC pause metric to InfluxDB input plugin.
- [#2006](https://github.com/yevheniir/telegraf-fork/pull/2006): Added response_timeout property to prometheus input plugin.
- [#1763](https://github.com/yevheniir/telegraf-fork/issues/1763): Pulling github.com/lxn/win's pdh wrapper into telegraf.
- [#1898](https://github.com/yevheniir/telegraf-fork/issues/1898): Support negative statsd counters.
- [#1921](https://github.com/yevheniir/telegraf-fork/issues/1921): Elasticsearch cluster stats support.
- [#1942](https://github.com/yevheniir/telegraf-fork/pull/1942): Change Amazon Kinesis output plugin to use the built-in serializer plugins.
- [#1980](https://github.com/yevheniir/telegraf-fork/issues/1980): Hide username/password from elasticsearch error log messages.
- [#2097](https://github.com/yevheniir/telegraf-fork/issues/2097): Configurable HTTP timeouts in Jolokia plugin
- [#2255](https://github.com/yevheniir/telegraf-fork/pull/2255): Allow changing jolokia attribute delimiter

### Bugfixes

- [#2049](https://github.com/yevheniir/telegraf-fork/pull/2049): Fix the Value data format not trimming null characters from input.
- [#1949](https://github.com/yevheniir/telegraf-fork/issues/1949): Fix windows `net` plugin.
- [#1775](https://github.com/yevheniir/telegraf-fork/issues/1775): Cache & expire metrics for delivery to prometheus
- [#1775](https://github.com/yevheniir/telegraf-fork/issues/1775): Cache & expire metrics for delivery to prometheus.
- [#2146](https://github.com/yevheniir/telegraf-fork/issues/2146): Fix potential panic in aggregator plugin metric maker.
- [#1843](https://github.com/yevheniir/telegraf-fork/pull/1843) & [#1668](https://github.com/yevheniir/telegraf-fork/issues/1668): Add optional ability to define PID as a tag.
- [#1730](https://github.com/yevheniir/telegraf-fork/issues/1730) & [#2261](https://github.com/yevheniir/telegraf-fork/pull/2261): Fix win_perf_counters not gathering non-English counters.
- [#2061](https://github.com/yevheniir/telegraf-fork/issues/2061): Fix panic when file stat info cannot be collected due to permissions or other issue(s).
- [#2045](https://github.com/yevheniir/telegraf-fork/issues/2045): Graylog output should set short_message field.
- [#1904](https://github.com/yevheniir/telegraf-fork/issues/1904): Hddtemp always put the value in the field temperature.
- [#1693](https://github.com/yevheniir/telegraf-fork/issues/1693): Properly collect nested jolokia struct data.
- [#1917](https://github.com/yevheniir/telegraf-fork/pull/1917): fix puppetagent inputs plugin to support string for config variable.
- [#1987](https://github.com/yevheniir/telegraf-fork/issues/1987): fix docker input plugin tags when registry has port.
- [#2089](https://github.com/yevheniir/telegraf-fork/issues/2089): Fix tail input when reading from a pipe.
- [#1449](https://github.com/yevheniir/telegraf-fork/issues/1449): MongoDB plugin always shows 0 replication lag.
- [#1825](https://github.com/yevheniir/telegraf-fork/issues/1825): Consul plugin: add check_id as a tag in metrics to avoid overwrites.
- [#1973](https://github.com/yevheniir/telegraf-fork/issues/1973): Partial fix: logparser CLF pattern with IPv6 addresses.
- [#1975](https://github.com/yevheniir/telegraf-fork/issues/1975) & [#2102](https://github.com/yevheniir/telegraf-fork/issues/2102): Fix thread-safety when using multiple instances of the statsd input plugin.
- [#2027](https://github.com/yevheniir/telegraf-fork/issues/2027): docker input: interface conversion panic fix.
- [#1814](https://github.com/yevheniir/telegraf-fork/issues/1814): snmp: ensure proper context is present on error messages.
- [#2299](https://github.com/yevheniir/telegraf-fork/issues/2299): opentsdb: add tcp:// prefix if no scheme provided.
- [#2297](https://github.com/yevheniir/telegraf-fork/issues/2297): influx parser: parse line-protocol without newlines.
- [#2245](https://github.com/yevheniir/telegraf-fork/issues/2245): influxdb output: fix field type conflict blocking output buffer.

## v1.1.2 [2016-12-12]

### Bugfixes

- [#2007](https://github.com/yevheniir/telegraf-fork/issues/2007): Make snmptranslate not required when using numeric OID.
- [#2104](https://github.com/yevheniir/telegraf-fork/issues/2104): Add a global snmp translation cache.

## v1.1.1 [2016-11-14]

### Bugfixes

- [#2023](https://github.com/yevheniir/telegraf-fork/issues/2023): Fix issue parsing toml durations with single quotes.
...
documentation for configuring journald. There is also a [`logfile` config option](https://github.com/yevheniir/telegraf-fork/blob/master/etc/telegraf.conf#L70)
...
- [#1726](https://github.com/yevheniir/telegraf-fork/issues/1726): Processor & Aggregator plugin support.
- [#1861](https://github.com/yevheniir/telegraf-fork/pull/1861): adding the tags in the graylog output plugin
- [#1732](https://github.com/yevheniir/telegraf-fork/pull/1732): Telegraf systemd service, log to journal.
- [#1782](https://github.com/yevheniir/telegraf-fork/pull/1782): Allow numeric and non-string values for tag_keys.
- [#1694](https://github.com/yevheniir/telegraf-fork/pull/1694): Adding Gauge and Counter metric types.
- [#1606](https://github.com/yevheniir/telegraf-fork/pull/1606): Remove carraige returns from exec plugin output on Windows
- [#1674](https://github.com/yevheniir/telegraf-fork/issues/1674): elasticsearch input: configurable timeout.
- [#1607](https://github.com/yevheniir/telegraf-fork/pull/1607): Massage metric names in Instrumental output plugin
- [#1572](https://github.com/yevheniir/telegraf-fork/pull/1572): mesos improvements.
- [#1513](https://github.com/yevheniir/telegraf-fork/issues/1513): Add Ceph Cluster Performance Statistics
- [#1650](https://github.com/yevheniir/telegraf-fork/issues/1650): Ability to configure response_timeout in httpjson input.
- [#1685](https://github.com/yevheniir/telegraf-fork/issues/1685): Add additional redis metrics.
- [#1539](https://github.com/yevheniir/telegraf-fork/pull/1539): Added capability to send metrics through Http API for OpenTSDB.
- [#1471](https://github.com/yevheniir/telegraf-fork/pull/1471): iptables input plugin.
- [#1542](https://github.com/yevheniir/telegraf-fork/pull/1542): Add filestack webhook plugin.
- [#1599](https://github.com/yevheniir/telegraf-fork/pull/1599): Add server hostname for each docker measurements.
- [#1697](https://github.com/yevheniir/telegraf-fork/pull/1697): Add NATS output plugin.
- [#1407](https://github.com/yevheniir/telegraf-fork/pull/1407) & [#1915](https://github.com/yevheniir/telegraf-fork/pull/1915): HTTP service listener input plugin.
- [#1699](https://github.com/yevheniir/telegraf-fork/pull/1699): Add database blacklist option for Postgresql
- [#1791](https://github.com/yevheniir/telegraf-fork/pull/1791): Add Docker container state metrics to Docker input plugin output
- [#1755](https://github.com/yevheniir/telegraf-fork/issues/1755): Add support to SNMP for IP & MAC address conversion.
- [#1729](https://github.com/yevheniir/telegraf-fork/issues/1729): Add support to SNMP for OID index suffixes.
- [#1813](https://github.com/yevheniir/telegraf-fork/pull/1813): Change default arguments for SNMP plugin.
- [#1686](https://github.com/yevheniir/telegraf-fork/pull/1686): Mesos input plugin: very high-cardinality mesos-task metrics removed.
- [#1838](https://github.com/yevheniir/telegraf-fork/pull/1838): Logging overhaul to centralize the logger & log levels, & provide a logfile config option.
- [#1700](https://github.com/yevheniir/telegraf-fork/pull/1700): HAProxy plugin socket glob matching.
- [#1847](https://github.com/yevheniir/telegraf-fork/pull/1847): Add Kubernetes plugin for retrieving pod metrics.

### Bugfixes

- [#1955](https://github.com/yevheniir/telegraf-fork/issues/1955): Fix NATS plug-ins reconnection logic.
- [#1936](https://github.com/yevheniir/telegraf-fork/issues/1936): Set required default values in udp_listener & tcp_listener.
- [#1926](https://github.com/yevheniir/telegraf-fork/issues/1926): Fix toml unmarshal panic in Duration objects.
- [#1746](https://github.com/yevheniir/telegraf-fork/issues/1746): Fix handling of non-string values for JSON keys listed in tag_keys.
- [#1628](https://github.com/yevheniir/telegraf-fork/issues/1628): Fix mongodb input panic on version 2.2.
- [#1733](https://github.com/yevheniir/telegraf-fork/issues/1733): Fix statsd scientific notation parsing
- [#1716](https://github.com/yevheniir/telegraf-fork/issues/1716): Sensors plugin strconv.ParseFloat: parsing "": invalid syntax
- [#1530](https://github.com/yevheniir/telegraf-fork/issues/1530): Fix prometheus_client reload panic
- [#1764](https://github.com/yevheniir/telegraf-fork/issues/1764): Fix kafka consumer panic when nil error is returned down errs channel.
- [#1768](https://github.com/yevheniir/telegraf-fork/pull/1768): Speed up statsd parsing.
- [#1751](https://github.com/yevheniir/telegraf-fork/issues/1751): Fix powerdns integer parse error handling.
- [#1752](https://github.com/yevheniir/telegraf-fork/issues/1752): Fix varnish plugin defaults not being used.
- [#1517](https://github.com/yevheniir/telegraf-fork/issues/1517): Fix windows glob paths.
- [#1137](https://github.com/yevheniir/telegraf-fork/issues/1137): Fix issue loading config directory on windows.
- [#1772](https://github.com/yevheniir/telegraf-fork/pull/1772): Windows remote management interactive service fix.
- [#1702](https://github.com/yevheniir/telegraf-fork/issues/1702): sqlserver, fix issue when case sensitive collation is activated.
- [#1823](https://github.com/yevheniir/telegraf-fork/issues/1823): Fix huge allocations in http_listener when dealing with huge payloads.
- [#1833](https://github.com/yevheniir/telegraf-fork/issues/1833): Fix translating SNMP fields not in MIB.
- [#1835](https://github.com/yevheniir/telegraf-fork/issues/1835): Fix SNMP emitting empty fields.
- [#1854](https://github.com/yevheniir/telegraf-fork/pull/1853): SQL Server waitstats truncation bug.
- [#1810](https://github.com/yevheniir/telegraf-fork/issues/1810): Fix logparser common log format: numbers in ident.
- [#1793](https://github.com/yevheniir/telegraf-fork/pull/1793): Fix JSON Serialization in OpenTSDB output.
- [#1731](https://github.com/yevheniir/telegraf-fork/issues/1731): Fix Graphite template ordering, use most specific.
- [#1836](https://github.com/yevheniir/telegraf-fork/pull/1836): Fix snmp table field initialization for non-automatic table.
- [#1724](https://github.com/yevheniir/telegraf-fork/issues/1724): cgroups path being parsed as metric.
- [#1886](https://github.com/yevheniir/telegraf-fork/issues/1886): Fix phpfpm fcgi client panic when URL does not exist.
- [#1344](https://github.com/yevheniir/telegraf-fork/issues/1344): Fix config file parse error logging.
- [#1771](https://github.com/yevheniir/telegraf-fork/issues/1771): Delete nil fields in the metric maker.
- [#870](https://github.com/yevheniir/telegraf-fork/issues/870): Fix MySQL special characters in DSN parsing.
- [#1742](https://github.com/yevheniir/telegraf-fork/issues/1742): Ping input odd timeout behavior.
- [#1950](https://github.com/yevheniir/telegraf-fork/pull/1950): Switch to github.com/kballard/go-shellquote.

## v1.0.1 [2016-09-26]

### Bugfixes

- [#1775](https://github.com/yevheniir/telegraf-fork/issues/1775): Prometheus output: Fix bug with multi-batch writes.
- [#1738](https://github.com/yevheniir/telegraf-fork/issues/1738): Fix unmarshal of influxdb metrics with null tags.
- [#1773](https://github.com/yevheniir/telegraf-fork/issues/1773): Add configurable timeout to influxdb input plugin.
- [#1785](https://github.com/yevheniir/telegraf-fork/pull/1785): Fix statsd no default value panic.
...
There is a [new SNMP plugin](https://github.com/yevheniir/telegraf-fork/tree/master/plugins/inputs/snmp)
...
- [#1617](https://github.com/yevheniir/telegraf-fork/pull/1617): postgresql_extensible now handles name and oid types correctly.
- [#1413](https://github.com/yevheniir/telegraf-fork/issues/1413): Separate container_version from container_image tag.
- [#1525](https://github.com/yevheniir/telegraf-fork/pull/1525): Support setting per-device and total metrics for Docker network and blockio.
- [#1466](https://github.com/yevheniir/telegraf-fork/pull/1466): MongoDB input plugin: adding per DB stats from db.stats()
- [#1503](https://github.com/yevheniir/telegraf-fork/pull/1503): Add tls support for certs to RabbitMQ input plugin
- [#1289](https://github.com/yevheniir/telegraf-fork/pull/1289): webhooks input plugin. Thanks @francois2metz and @cduez!
- [#1247](https://github.com/yevheniir/telegraf-fork/pull/1247): rollbar webhook plugin.
- [#1408](https://github.com/yevheniir/telegraf-fork/pull/1408): mandrill webhook plugin.
- [#1402](https://github.com/yevheniir/telegraf-fork/pull/1402): docker-machine/boot2docker no longer required for unit tests.
- [#1350](https://github.com/yevheniir/telegraf-fork/pull/1350): cgroup input plugin.
- [#1369](https://github.com/yevheniir/telegraf-fork/pull/1369): Add input plugin for consuming metrics from NSQD.
- [#1369](https://github.com/yevheniir/telegraf-fork/pull/1480): add ability to read redis from a socket.
- [#1387](https://github.com/yevheniir/telegraf-fork/pull/1387): **Breaking Change** - Redis `role` tag renamed to `replication_role` to avoid global_tags override
- [#1437](https://github.com/yevheniir/telegraf-fork/pull/1437): Fetching Galera status metrics in MySQL
- [#1500](https://github.com/yevheniir/telegraf-fork/pull/1500): Aerospike plugin refactored to use official client lib.
- [#1434](https://github.com/yevheniir/telegraf-fork/pull/1434): Add measurement name arg to logparser plugin.
- [#1479](https://github.com/yevheniir/telegraf-fork/pull/1479): logparser: change resp_code from a field to a tag.
- [#1411](https://github.com/yevheniir/telegraf-fork/pull/1411): Implement support for fetching hddtemp data
- [#1340](https://github.com/yevheniir/telegraf-fork/issues/1340): statsd: do not log every dropped metric.
- [#1368](https://github.com/yevheniir/telegraf-fork/pull/1368): Add precision rounding to all metrics on collection.
- [#1390](https://github.com/yevheniir/telegraf-fork/pull/1390): Add support for Tengine
- [#1320](https://github.com/yevheniir/telegraf-fork/pull/1320): Logparser input plugin for parsing grok-style log patterns.
- [#1397](https://github.com/yevheniir/telegraf-fork/issues/1397): ElasticSearch: now supports connecting to ElasticSearch via SSL
- [#1262](https://github.com/yevheniir/telegraf-fork/pull/1261): Add graylog input pluging.
- [#1294](https://github.com/yevheniir/telegraf-fork/pull/1294): consul input plugin. Thanks @harnash
- [#1164](https://github.com/yevheniir/telegraf-fork/pull/1164): conntrack input plugin. Thanks @robinpercy!
- [#1165](https://github.com/yevheniir/telegraf-fork/pull/1165): vmstat input plugin. Thanks @jshim-xm!
- [#1208](https://github.com/yevheniir/telegraf-fork/pull/1208): Standardized AWS credentials evaluation & wildcard CloudWatch dimensions. Thanks @johnrengelman!
- [#1264](https://github.com/yevheniir/telegraf-fork/pull/1264): Add SSL config options to http_response plugin.
- [#1272](https://github.com/yevheniir/telegraf-fork/pull/1272): graphite parser: add ability to specify multiple tag keys, for consistency with influxdb parser.
- [#1265](https://github.com/yevheniir/telegraf-fork/pull/1265): Make dns lookups for chrony configurable. Thanks @zbindenren!
- [#1275](https://github.com/yevheniir/telegraf-fork/pull/1275): Allow wildcard filtering of varnish stats.
- [#1142](https://github.com/yevheniir/telegraf-fork/pull/1142): Support for glob patterns in exec plugin commands configuration.
- [#1278](https://github.com/yevheniir/telegraf-fork/pull/1278): RabbitMQ input: made url parameter optional by using DefaultURL (http://localhost:15672) if not specified
- [#1197](https://github.com/yevheniir/telegraf-fork/pull/1197): Limit AWS GetMetricStatistics requests to 10 per second.
- [#1278](https://github.com/yevheniir/telegraf-fork/pull/1278) & [#1288](https://github.com/yevheniir/telegraf-fork/pull/1288) & [#1295](https://github.com/yevheniir/telegraf-fork/pull/1295): RabbitMQ/Apache/InfluxDB inputs: made url(s) parameter optional by using reasonable input defaults if not specified
- [#1296](https://github.com/yevheniir/telegraf-fork/issues/1296): Refactor of flush_jitter argument.
- [#1213](https://github.com/yevheniir/telegraf-fork/issues/1213): Add inactive & active memory to mem plugin.
- [#1543](https://github.com/yevheniir/telegraf-fork/pull/1543): Official Windows service.
- [#1414](https://github.com/yevheniir/telegraf-fork/pull/1414): Forking sensors command to remove C package dependency.
- [#1389](https://github.com/yevheniir/telegraf-fork/pull/1389): Add a new SNMP plugin.

### Bugfixes

- [#1619](https://github.com/yevheniir/telegraf-fork/issues/1619): Fix `make windows` build target
- [#1519](https://github.com/yevheniir/telegraf-fork/pull/1519): Fix error race conditions and partial failures.
- [#1477](https://github.com/yevheniir/telegraf-fork/issues/1477): nstat: fix inaccurate config panic.
- [#1481](https://github.com/yevheniir/telegraf-fork/issues/1481): jolokia: fix handling multiple multi-dimensional attributes.
- [#1430](https://github.com/yevheniir/telegraf-fork/issues/1430): Fix prometheus character sanitizing. Sanitize more win_perf_counters characters.
- [#1534](https://github.com/yevheniir/telegraf-fork/pull/1534): Add diskio io_time to FreeBSD & report timing metrics as ms (as linux does).
- [#1379](https://github.com/yevheniir/telegraf-fork/issues/1379): Fix covering Amazon Linux for post remove flow.
- [#1584](https://github.com/yevheniir/telegraf-fork/issues/1584): procstat missing fields: read/write bytes & count
- [#1472](https://github.com/yevheniir/telegraf-fork/pull/1472): diskio input plugin: set 'skip_serial_number = true' by default to avoid high cardinality.
- [#1426](https://github.com/yevheniir/telegraf-fork/pull/1426): nil metrics panic fix.
- [#1384](https://github.com/yevheniir/telegraf-fork/pull/1384): Fix datarace in apache input plugin.
- [#1399](https://github.com/yevheniir/telegraf-fork/issues/1399): Add `read_repairs` statistics to riak plugin.
- [#1405](https://github.com/yevheniir/telegraf-fork/issues/1405): Fix memory/connection leak in prometheus input plugin.
- [#1378](https://github.com/yevheniir/telegraf-fork/issues/1378): Trim BOM from config file for Windows support.
- [#1339](https://github.com/yevheniir/telegraf-fork/issues/1339): Prometheus client output panic on service reload.
- [#1461](https://github.com/yevheniir/telegraf-fork/pull/1461): Prometheus parser, protobuf format header fix.
- [#1334](https://github.com/yevheniir/telegraf-fork/issues/1334): Prometheus output, metric refresh and caching fixes.
- [#1432](https://github.com/yevheniir/telegraf-fork/issues/1432): Panic fix for multiple graphite outputs under very high load.
- [#1412](https://github.com/yevheniir/telegraf-fork/pull/1412): Instrumental output has better reconnect behavior
- [#1460](https://github.com/yevheniir/telegraf-fork/issues/1460): Remove PID from procstat plugin to fix cardinality issues.
- [#1427](https://github.com/yevheniir/telegraf-fork/issues/1427): Cassandra input: version 2.x "column family" fix.
- [#1463](https://github.com/yevheniir/telegraf-fork/issues/1463): Shared WaitGroup in Exec plugin
- [#1436](https://github.com/yevheniir/telegraf-fork/issues/1436): logparser: honor modifiers in "pattern" config.
- [#1418](https://github.com/yevheniir/telegraf-fork/issues/1418): logparser: error and exit on file permissions/missing errors.
- [#1499](https://github.com/yevheniir/telegraf-fork/pull/1499): Make the user able to specify full path for HAproxy stats
- [#1521](https://github.com/yevheniir/telegraf-fork/pull/1521): Fix Redis url, an extra "tcp://" was added.
- [#1330](https://github.com/yevheniir/telegraf-fork/issues/1330): Fix exec plugin panic when using single binary.
- [#1336](https://github.com/yevheniir/telegraf-fork/issues/1336): Fixed incorrect prometheus metrics source selection.
- [#1112](https://github.com/yevheniir/telegraf-fork/issues/1112): Set default Zookeeper chroot to empty string.
- [#1335](https://github.com/yevheniir/telegraf-fork/issues/1335): Fix overall ping timeout to be calculated based on per-ping timeout.
- [#1374](https://github.com/yevheniir/telegraf-fork/pull/1374): Change "default" retention policy to "".
- [#1377](https://github.com/yevheniir/telegraf-fork/issues/1377): Graphite output mangling '%' character.
- [#1396](https://github.com/yevheniir/telegraf-fork/pull/1396): Prometheus input plugin now supports x509 certs authentication
- [#1252](https://github.com/yevheniir/telegraf-fork/pull/1252) & [#1279](https://github.com/yevheniir/telegraf-fork/pull/1279): Fix systemd service. Thanks @zbindenren & @PierreF!
- [#1221](https://github.com/yevheniir/telegraf-fork/pull/1221): Fix influxdb n_shards counter.
- [#1258](https://github.com/yevheniir/telegraf-fork/pull/1258): Fix potential kernel plugin integer parse error.
- [#1268](https://github.com/yevheniir/telegraf-fork/pull/1268): Fix potential influxdb input type assertion panic.
- [#1283](https://github.com/yevheniir/telegraf-fork/pull/1283): Still send processes metrics if a process exited during metric collection.
- [#1297](https://github.com/yevheniir/telegraf-fork/issues/1297): disk plugin panic when usage grab fails.
- [#1316](https://github.com/yevheniir/telegraf-fork/pull/1316): Removed leaked "database" tag on redis metrics. Thanks @PierreF!
- [#1323](https://github.com/yevheniir/telegraf-fork/issues/1323): Processes plugin: fix potential error with /proc/net/stat directory.
- [#1322](https://github.com/yevheniir/telegraf-fork/issues/1322): Fix rare RHEL 5.2 panic in gopsutil diskio gathering function.
- [#1586](https://github.com/yevheniir/telegraf-fork/pull/1586): Remove IF NOT EXISTS from influxdb output database creation.
- [#1600](https://github.com/yevheniir/telegraf-fork/issues/1600): Fix quoting with text values in postgresql_extensible plugin.
- [#1425](https://github.com/yevheniir/telegraf-fork/issues/1425): Fix win_perf_counter "index out of range" panic.
- [#1634](https://github.com/yevheniir/telegraf-fork/issues/1634): Fix ntpq panic when field is missing.
- [#1637](https://github.com/yevheniir/telegraf-fork/issues/1637): Sanitize graphite output field names.
- [#1695](https://github.com/yevheniir/telegraf-fork/pull/1695): Fix MySQL plugin not sending 0 value fields.
...
- [#1173](https://github.com/yevheniir/telegraf-fork/pull/1173): varnish input plugin. Thanks @sfox-xmatters!
- [#1138](https://github.com/yevheniir/telegraf-fork/pull/1138): nstat input plugin. Thanks @Maksadbek!
- [#1139](https://github.com/yevheniir/telegraf-fork/pull/1139): instrumental output plugin. Thanks @jasonroelofs!
- [#1172](https://github.com/yevheniir/telegraf-fork/pull/1172): Ceph storage stats. Thanks @robinpercy!
- [#1233](https://github.com/yevheniir/telegraf-fork/pull/1233): Updated golint gopsutil dependency.
- [#1238](https://github.com/yevheniir/telegraf-fork/pull/1238): chrony input plugin. Thanks @zbindenren!
- [#479](https://github.com/yevheniir/telegraf-fork/issues/479): per-plugin execution time added to debug output.
- [#1249](https://github.com/yevheniir/telegraf-fork/issues/1249): influxdb output: added write_consistency argument.

### Bugfixes

- [#1195](https://github.com/yevheniir/telegraf-fork/pull/1195): Docker panic on timeout. Thanks @zstyblik!
- [#1211](https://github.com/yevheniir/telegraf-fork/pull/1211): mongodb input. Fix possible panic. Thanks @kols!
- [#1215](https://github.com/yevheniir/telegraf-fork/pull/1215): Fix for possible gopsutil-dependent plugin hangs.
- [#1228](https://github.com/yevheniir/telegraf-fork/pull/1228): Fix service plugin host tag overwrite.
- [#1198](https://github.com/yevheniir/telegraf-fork/pull/1198): http_response: override request Host header properly
- [#1230](https://github.com/yevheniir/telegraf-fork/issues/1230): Fix Telegraf process hangup due to a single plugin hanging.
- [#1214](https://github.com/yevheniir/telegraf-fork/issues/1214): Use TCP timeout argument in net_response plugin.
- [#1243](https://github.com/yevheniir/telegraf-fork/pull/1243): Logfile not created on systemd.
...
https://github.com/yevheniir/telegraf-fork/blob/master/plugins/inputs/jolokia/README.md
...
[the configuration doc](https://github.com/yevheniir/telegraf-fork/blob/master/docs/CONFIGURATION.md)
for more details.
...
- [#1031](https://github.com/yevheniir/telegraf-fork/pull/1031): Jolokia plugin proxy mode. Thanks @saiello!
- [#1017](https://github.com/yevheniir/telegraf-fork/pull/1017): taginclude and tagexclude arguments.
- [#1015](https://github.com/yevheniir/telegraf-fork/pull/1015): Docker plugin schema refactor.
- [#889](https://github.com/yevheniir/telegraf-fork/pull/889): Improved MySQL plugin. Thanks @maksadbek!
- [#1060](https://github.com/yevheniir/telegraf-fork/pull/1060): TTL metrics added to MongoDB input plugin
- [#1056](https://github.com/yevheniir/telegraf-fork/pull/1056): Don't allow inputs to overwrite host tags.
- [#1035](https://github.com/yevheniir/telegraf-fork/issues/1035): Add `user`, `exe`, `pidfile` tags to procstat plugin.
- [#1041](https://github.com/yevheniir/telegraf-fork/issues/1041): Add `n_cpus` field to the system plugin.
- [#1072](https://github.com/yevheniir/telegraf-fork/pull/1072): New Input Plugin: filestat.
- [#1066](https://github.com/yevheniir/telegraf-fork/pull/1066): Replication lag metrics for MongoDB input plugin
- [#1086](https://github.com/yevheniir/telegraf-fork/pull/1086): Ability to specify AWS keys in config file. Thanks @johnrengleman!
- [#1096](https://github.com/yevheniir/telegraf-fork/pull/1096): Performance refactor of running output buffers.
- [#967](https://github.com/yevheniir/telegraf-fork/issues/967): Buffer logging improvements.
- [#1107](https://github.com/yevheniir/telegraf-fork/issues/1107): Support lustre2 job stats. Thanks @hanleyja!
- [#1122](https://github.com/yevheniir/telegraf-fork/pull/1122): Support setting config path through env variable and default paths.
- [#1128](https://github.com/yevheniir/telegraf-fork/pull/1128): MongoDB jumbo chunks metric for MongoDB input plugin
- [#1146](https://github.com/yevheniir/telegraf-fork/pull/1146): HAProxy socket support. Thanks weshmashian!

### Bugfixes

- [#1050](https://github.com/yevheniir/telegraf-fork/issues/1050): jolokia plugin - do not overwrite host tag. Thanks @saiello!
- [#921](https://github.com/yevheniir/telegraf-fork/pull/921): mqtt_consumer stops gathering metrics. Thanks @chaton78!
- [#1013](https://github.com/yevheniir/telegraf-fork/pull/1013): Close dead riemann output connections. Thanks @echupriyanov!
- [#1012](https://github.com/yevheniir/telegraf-fork/pull/1012): Set default tags in test accumulator.
- [#1024](https://github.com/yevheniir/telegraf-fork/issues/1024): Don't replace `.` with `_` in datadog output.
- [#1058](https://github.com/yevheniir/telegraf-fork/issues/1058): Fix possible leaky TCP connections in influxdb output.
- [#1044](https://github.com/yevheniir/telegraf-fork/pull/1044): Fix SNMP OID possible collisions. Thanks @relip
- [#1022](https://github.com/yevheniir/telegraf-fork/issues/1022): Dont error deb/rpm install on systemd errors.
- [#1078](https://github.com/yevheniir/telegraf-fork/issues/1078): Use default AWS credential chain.
- [#1070](https://github.com/yevheniir/telegraf-fork/issues/1070): SQL Server input. Fix datatype conversion.
- [#1089](https://github.com/yevheniir/telegraf-fork/issues/1089): Fix leaky TCP connections in phpfpm plugin.
- [#914](https://github.com/yevheniir/telegraf-fork/issues/914): Telegraf can drop metrics on full buffers.
- [#1098](https://github.com/yevheniir/telegraf-fork/issues/1098): Sanitize invalid OpenTSDB characters.
- [#1110](https://github.com/yevheniir/telegraf-fork/pull/1110): Sanitize * to - in graphite serializer. Thanks @goodeggs!
- [#1118](https://github.com/yevheniir/telegraf-fork/pull/1118): Sanitize Counter names for `win_perf_counters` input.
- [#1125](https://github.com/yevheniir/telegraf-fork/pull/1125): Wrap all exec command runners with a timeout, so hung os processes don't halt Telegraf.
- [#1113](https://github.com/yevheniir/telegraf-fork/pull/1113): Set MaxRetry and RequiredAcks defaults in Kafka output.
- [#1090](https://github.com/yevheniir/telegraf-fork/issues/1090): [agent] and [global_tags] config sometimes not getting applied.
- [#1133](https://github.com/yevheniir/telegraf-fork/issues/1133): Use a timeout for docker list & stat cmds.
- [#1052](https://github.com/yevheniir/telegraf-fork/issues/1052): Docker panic fix when decode fails.
- [#1136](https://github.com/yevheniir/telegraf-fork/pull/1136): "DELAYED" Inserts were deprecated in MySQL 5.6.6. Thanks @PierreF
...
https://github.com/yevheniir/telegraf-fork/blob/master/docs/DATA_FORMATS_OUTPUT.md#graphite
...
### Features
- [#1009](https://github.com/yevheniir/telegraf-fork/pull/1009): Cassandra input plugin. Thanks @subhachandrachandra!
- [#976](https://github.com/yevheniir/telegraf-fork/pull/976): Reduce allocations in the UDP and statsd inputs.
- [#979](https://github.com/yevheniir/telegraf-fork/pull/979): Reduce allocations in the TCP listener.
- [#992](https://github.com/yevheniir/telegraf-fork/pull/992): Refactor allocations in TCP/UDP listeners.
- [#935](https://github.com/yevheniir/telegraf-fork/pull/935): AWS Cloudwatch input plugin. Thanks @joshhardy & @ljosa!
- [#943](https://github.com/yevheniir/telegraf-fork/pull/943): http_response input plugin. Thanks @Lswith!
- [#939](https://github.com/yevheniir/telegraf-fork/pull/939): sysstat input plugin. Thanks @zbindenren!
- [#998](https://github.com/yevheniir/telegraf-fork/pull/998): **breaking change** enabled global, user and ip queries in dovecot plugin. Thanks @mikif70!
- [#1001](https://github.com/yevheniir/telegraf-fork/pull/1001): Graphite serializer templates.
- [#1008](https://github.com/yevheniir/telegraf-fork/pull/1008): Adding memstats metrics to the influxdb plugin.

### Bugfixes
- [#968](https://github.com/yevheniir/telegraf-fork/issues/968): Processes plugin gets unknown state when spaces are in (command name)
- [#969](https://github.com/yevheniir/telegraf-fork/pull/969): ipmi_sensors: allow : in password. Thanks @awaw!
- [#972](https://github.com/yevheniir/telegraf-fork/pull/972): dovecot: remove extra newline in dovecot command. Thanks @mrannanj!
- [#645](https://github.com/yevheniir/telegraf-fork/issues/645): docker plugin i/o error on closed pipe. Thanks @tripledes!

## v0.12.0 [2016-04-05]

### Features
- [#951](https://github.com/yevheniir/telegraf-fork/pull/951): Parse environment variables in the config file.
- [#948](https://github.com/yevheniir/telegraf-fork/pull/948): Cleanup config file and make default package version include all plugins (but commented).
- [#927](https://github.com/yevheniir/telegraf-fork/pull/927): Adds parsing of tags to the statsd input when using DataDog's dogstatsd extension
- [#863](https://github.com/yevheniir/telegraf-fork/pull/863): AMQP output: allow external auth. Thanks @ekini!
- [#707](https://github.com/yevheniir/telegraf-fork/pull/707): Improved prometheus plugin. Thanks @titilambert!
- [#878](https://github.com/yevheniir/telegraf-fork/pull/878): Added json serializer. Thanks @ch3lo!
- [#880](https://github.com/yevheniir/telegraf-fork/pull/880): Add the ability to specify the bearer token to the prometheus plugin. Thanks @jchauncey!
- [#882](https://github.com/yevheniir/telegraf-fork/pull/882): Fixed SQL Server Plugin issues
- [#849](https://github.com/yevheniir/telegraf-fork/issues/849): Adding ability to parse single values as an input data type.
- [#844](https://github.com/yevheniir/telegraf-fork/pull/844): postgres_extensible plugin added. Thanks @menardorama!
- [#866](https://github.com/yevheniir/telegraf-fork/pull/866): couchbase input plugin. Thanks @ljosa!
- [#789](https://github.com/yevheniir/telegraf-fork/pull/789): Support multiple field specification and `field*` in graphite templates. Thanks @chrusty!
- [#762](https://github.com/yevheniir/telegraf-fork/pull/762): Nagios parser for the exec plugin. Thanks @titilambert!
- [#848](https://github.com/yevheniir/telegraf-fork/issues/848): Provide option to omit host tag from telegraf agent.
- [#928](https://github.com/yevheniir/telegraf-fork/pull/928): Deprecating the statsd "convert_names" options, expose separator config.
- [#919](https://github.com/yevheniir/telegraf-fork/pull/919): ipmi_sensor input plugin. Thanks @ebookbug!
- [#945](https://github.com/yevheniir/telegraf-fork/pull/945): KAFKA output: codec, acks, and retry configuration. Thanks @framiere!

### Bugfixes
- [#890](https://github.com/yevheniir/telegraf-fork/issues/890): Create TLS config even if only ssl_ca is provided.
- [#884](https://github.com/yevheniir/telegraf-fork/issues/884): Do not call write method if there are 0 metrics to write.
- [#898](https://github.com/yevheniir/telegraf-fork/issues/898): Put database name in quotes, fixes special characters in the database name.
- [#656](https://github.com/yevheniir/telegraf-fork/issues/656): No longer run `lsof` on linux to get netstat data, fixes permissions issue.
- [#907](https://github.com/yevheniir/telegraf-fork/issues/907): Fix prometheus invalid label/measurement name key.
- [#841](https://github.com/yevheniir/telegraf-fork/issues/841): Fix memcached unix socket panic.
- [#873](https://github.com/yevheniir/telegraf-fork/issues/873): Fix SNMP plugin sometimes not returning metrics. Thanks @titiliambert!
- [#934](https://github.com/yevheniir/telegraf-fork/pull/934): phpfpm: Fix fcgi uri path. Thanks @rudenkovk!
- [#805](https://github.com/yevheniir/telegraf-fork/issues/805): Kafka consumer stops gathering after i/o timeout.
- [#959](https://github.com/yevheniir/telegraf-fork/pull/959): reduce mongodb & prometheus collection timeouts. Thanks @PierreF!

## v0.11.1 [2016-03-17]

### Release Notes
- Primarily this release was cut to fix [#859](https://github.com/yevheniir/telegraf-fork/issues/859)

### Features
- [#747](https://github.com/yevheniir/telegraf-fork/pull/747): Start telegraf on install & remove on uninstall. Thanks @pierref!
- [#794](https://github.com/yevheniir/telegraf-fork/pull/794): Add service reload ability. Thanks @entertainyou!

### Bugfixes
- [#852](https://github.com/yevheniir/telegraf-fork/issues/852): Windows zip package fix
- [#859](https://github.com/yevheniir/telegraf-fork/issues/859): httpjson plugin panic
...
### Features
- [#692](https://github.com/yevheniir/telegraf-fork/pull/770): Support InfluxDB retention policies
- [#771](https://github.com/yevheniir/telegraf-fork/pull/771): Default timeouts for input plugns. Thanks @PierreF!
- [#758](https://github.com/yevheniir/telegraf-fork/pull/758): UDP Listener input plugin, thanks @whatyouhide!
- [#769](https://github.com/yevheniir/telegraf-fork/issues/769): httpjson plugin: allow specifying SSL configuration.
- [#735](https://github.com/yevheniir/telegraf-fork/pull/735): SNMP Table feature. Thanks @titilambert!
- [#754](https://github.com/yevheniir/telegraf-fork/pull/754): docker plugin: adding `docker info` metrics to output. Thanks @titilambert!
- [#788](https://github.com/yevheniir/telegraf-fork/pull/788): -input-list and -output-list command-line options. Thanks @ebookbug!
- [#778](https://github.com/yevheniir/telegraf-fork/pull/778): Adding a TCP input listener.
- [#797](https://github.com/yevheniir/telegraf-fork/issues/797): Provide option for persistent MQTT consumer client sessions.
- [#799](https://github.com/yevheniir/telegraf-fork/pull/799): Add number of threads for procstat input plugin. Thanks @titilambert!
- [#776](https://github.com/yevheniir/telegraf-fork/pull/776): Add Zookeeper chroot option to kafka_consumer. Thanks @prune998!
- [#811](https://github.com/yevheniir/telegraf-fork/pull/811): Add processes plugin for classifying total procs on system. Thanks @titilambert!
- [#235](https://github.com/yevheniir/telegraf-fork/issues/235): Add number of users to the `system` input plugin.
- [#826](https://github.com/yevheniir/telegraf-fork/pull/826): "kernel" linux plugin for /proc/stat metrics (context switches, interrupts, etc.)
- [#847](https://github.com/yevheniir/telegraf-fork/pull/847): `ntpq`: Input plugin for running ntp query executable and gathering metrics.

### Bugfixes
- [#748](https://github.com/yevheniir/telegraf-fork/issues/748): Fix sensor plugin split on ":"
- [#722](https://github.com/yevheniir/telegraf-fork/pull/722): Librato output plugin fixes. Thanks @chrusty!
- [#745](https://github.com/yevheniir/telegraf-fork/issues/745): Fix Telegraf toml parse panic on large config files. Thanks @titilambert!
- [#781](https://github.com/yevheniir/telegraf-fork/pull/781): Fix mqtt_consumer username not being set. Thanks @chaton78!
- [#786](https://github.com/yevheniir/telegraf-fork/pull/786): Fix mqtt output username not being set. Thanks @msangoi!
- [#773](https://github.com/yevheniir/telegraf-fork/issues/773): Fix duplicate measurements in snmp plugin. Thanks @titilambert!
- [#708](https://github.com/yevheniir/telegraf-fork/issues/708): packaging: build ARM package
- [#713](https://github.com/yevheniir/telegraf-fork/issues/713): packaging: insecure permissions error on log directory
- [#816](https://github.com/yevheniir/telegraf-fork/issues/816): Fix phpfpm panic if fcgi endpoint unreachable.
- [#828](https://github.com/yevheniir/telegraf-fork/issues/828): fix net_response plugin overwriting host tag.
- [#821](https://github.com/yevheniir/telegraf-fork/issues/821): Remove postgres password from server tag. Thanks @menardorama!
...
### Bugfixes
- [#750](https://github.com/yevheniir/telegraf-fork/issues/750): deb package broken
- [#752](https://github.com/yevheniir/telegraf-fork/issues/752): rpm package broken
...
### Features
- [#727](https://github.com/yevheniir/telegraf-fork/pull/727): riak input, thanks @jcoene!
- [#694](https://github.com/yevheniir/telegraf-fork/pull/694): DNS Query input, thanks @mjasion!
- [#724](https://github.com/yevheniir/telegraf-fork/pull/724): username matching for procstat input, thanks @zorel!
- [#736](https://github.com/yevheniir/telegraf-fork/pull/736): Ignore dummy filesystems from disk plugin. Thanks @PierreF!
- [#737](https://github.com/yevheniir/telegraf-fork/pull/737): Support multiple fields for statsd input. Thanks @mattheath!

### Bugfixes
- [#701](https://github.com/yevheniir/telegraf-fork/pull/701): output write count shouldnt print in quiet mode.
- [#746](https://github.com/yevheniir/telegraf-fork/pull/746): httpjson plugin: Fix HTTP GET parameters.
...
[here](https://github.com/yevheniir/telegraf-fork/blob/master/docs/DATA_FORMATS_INPUT.md)
- More info on serializing _outgoing_ data formats can be found
[here](https://github.com/yevheniir/telegraf-fork/blob/master/docs/DATA_FORMATS_OUTPUT.md)
...
### Features
- [#652](https://github.com/yevheniir/telegraf-fork/pull/652): CouchDB Input Plugin. Thanks @codehate!
- [#655](https://github.com/yevheniir/telegraf-fork/pull/655): Support parsing arbitrary data formats. Currently limited to kafka_consumer and exec inputs.
- [#671](https://github.com/yevheniir/telegraf-fork/pull/671): Dovecot input plugin. Thanks @mikif70!
- [#680](https://github.com/yevheniir/telegraf-fork/pull/680): NATS consumer input plugin. Thanks @netixen!
- [#676](https://github.com/yevheniir/telegraf-fork/pull/676): MQTT consumer input plugin.
- [#683](https://github.com/yevheniir/telegraf-fork/pull/683): PostGRES input plugin: add pg_stat_bgwriter. Thanks @menardorama!
- [#679](https://github.com/yevheniir/telegraf-fork/pull/679): File/stdout output plugin.
- [#679](https://github.com/yevheniir/telegraf-fork/pull/679): Support for arbitrary output data formats.
- [#695](https://github.com/yevheniir/telegraf-fork/pull/695): raindrops input plugin. Thanks @burdandrei!
- [#650](https://github.com/yevheniir/telegraf-fork/pull/650): net_response input plugin. Thanks @titilambert!
- [#699](https://github.com/yevheniir/telegraf-fork/pull/699): Flush based on buffer size rather than time.
- [#682](https://github.com/yevheniir/telegraf-fork/pull/682): Mesos input plugin. Thanks @tripledes!

### Bugfixes
- [#443](https://github.com/yevheniir/telegraf-fork/issues/443): Fix Ping command timeout parameter on Linux.
- [#662](https://github.com/yevheniir/telegraf-fork/pull/667): Change `[tags]` to `[global_tags]` to fix multiple-plugin tags bug.
- [#642](https://github.com/yevheniir/telegraf-fork/issues/642): Riemann output plugin issues.
- [#394](https://github.com/yevheniir/telegraf-fork/issues/394): Support HTTP POST. Thanks @gabelev!
- [#715](https://github.com/yevheniir/telegraf-fork/pull/715): Fix influxdb precision config panic. Thanks @netixen!
...
### Features
- [#575](https://github.com/yevheniir/telegraf-fork/pull/575): Support for collecting Windows Performance Counters. Thanks @TheFlyingCorpse!
- [#564](https://github.com/yevheniir/telegraf-fork/issues/564): features for plugin writing simplification. Internal metric data type.
- [#603](https://github.com/yevheniir/telegraf-fork/pull/603): Aggregate statsd timing measurements into fields. Thanks @marcinbunsch!
- [#601](https://github.com/yevheniir/telegraf-fork/issues/601): Warn when overwriting cached metrics.
- [#614](https://github.com/yevheniir/telegraf-fork/pull/614): PowerDNS input plugin. Thanks @Kasen!
- [#617](https://github.com/yevheniir/telegraf-fork/pull/617): exec plugin: parse influx line protocol in addition to JSON.
- [#628](https://github.com/yevheniir/telegraf-fork/pull/628): Windows perf counters: pre-vista support

### Bugfixes
- [#595](https://github.com/yevheniir/telegraf-fork/issues/595): graphite output should include tags to separate duplicate measurements.
- [#599](https://github.com/yevheniir/telegraf-fork/issues/599): datadog plugin tags not working.
- [#600](https://github.com/yevheniir/telegraf-fork/issues/600): datadog measurement/field name parsing is wrong.
- [#602](https://github.com/yevheniir/telegraf-fork/issues/602): Fix statsd field name templating.
- [#612](https://github.com/yevheniir/telegraf-fork/pull/612): Docker input panic fix if stats received are nil.
- [#634](https://github.com/yevheniir/telegraf-fork/pull/634): Properly set host headers in httpjson. Thanks @reginaldosousa!
...
[See the readme](https://github.com/yevheniir/telegraf-fork/blob/master/plugins/inputs/docker/README.md)
...
### Features
- [#509](https://github.com/yevheniir/telegraf-fork/pull/509): Flatten JSON arrays with indices. Thanks @psilva261!
- [#512](https://github.com/yevheniir/telegraf-fork/pull/512): Python 3 build script, add lsof dep to package. Thanks @Ormod!
- [#475](https://github.com/yevheniir/telegraf-fork/pull/475): Add response time to httpjson plugin. Thanks @titilambert!
- [#519](https://github.com/yevheniir/telegraf-fork/pull/519): Added a sensors input based on lm-sensors. Thanks @md14454!
- [#467](https://github.com/yevheniir/telegraf-fork/issues/467): Add option to disable statsd measurement name conversion.
- [#534](https://github.com/yevheniir/telegraf-fork/pull/534): NSQ input plugin. Thanks @allingeek!
- [#494](https://github.com/yevheniir/telegraf-fork/pull/494): Graphite output plugin. Thanks @titilambert!
- AMQP SSL support. Thanks @ekini!
- [#539](https://github.com/yevheniir/telegraf-fork/pull/539): Reload config on SIGHUP. Thanks @titilambert!
- [#522](https://github.com/yevheniir/telegraf-fork/pull/522): Phusion passenger input plugin. Thanks @kureikain!
- [#541](https://github.com/yevheniir/telegraf-fork/pull/541): Kafka output TLS cert support. Thanks @Ormod!
- [#551](https://github.com/yevheniir/telegraf-fork/pull/551): Statsd UDP read packet size now defaults to 1500 bytes, and is configurable.
- [#552](https://github.com/yevheniir/telegraf-fork/pull/552): Support for collection interval jittering.
- [#484](https://github.com/yevheniir/telegraf-fork/issues/484): Include usage percent with procstat metrics.
- [#553](https://github.com/yevheniir/telegraf-fork/pull/553): Amazon CloudWatch output. thanks @skwong2!
- [#503](https://github.com/yevheniir/telegraf-fork/pull/503): Support docker endpoint configuration.
- [#563](https://github.com/yevheniir/telegraf-fork/pull/563): Docker plugin overhaul.
- [#285](https://github.com/yevheniir/telegraf-fork/issues/285): Fixed-size buffer of points.
- [#546](https://github.com/yevheniir/telegraf-fork/pull/546): SNMP Input plugin. Thanks @titilambert!
- [#589](https://github.com/yevheniir/telegraf-fork/pull/589): Microsoft SQL Server input plugin. Thanks @zensqlmonitor!
- [#573](https://github.com/yevheniir/telegraf-fork/pull/573): Github webhooks consumer input. Thanks @jackzampolin!
- [#471](https://github.com/yevheniir/telegraf-fork/pull/471): httpjson request headers. Thanks @asosso!

### Bugfixes
- [#506](https://github.com/yevheniir/telegraf-fork/pull/506): Ping input doesn't return response time metric when timeout. Thanks @titilambert!
- [#508](https://github.com/yevheniir/telegraf-fork/pull/508): Fix prometheus cardinality issue with the `net` plugin
- [#499](https://github.com/yevheniir/telegraf-fork/issues/499) & [#502](https://github.com/yevheniir/telegraf-fork/issues/502): php fpm unix socket and other fixes, thanks @kureikain!
- [#543](https://github.com/yevheniir/telegraf-fork/issues/543): Statsd Packet size sometimes truncated.
- [#440](https://github.com/yevheniir/telegraf-fork/issues/440): Don't query filtered devices for disk stats.
- [#463](https://github.com/yevheniir/telegraf-fork/issues/463): Docker plugin not working on AWS Linux
- [#568](https://github.com/yevheniir/telegraf-fork/issues/568): Multiple output race condition.
- [#585](https://github.com/yevheniir/telegraf-fork/pull/585): Log stack trace and continue on Telegraf panic. Thanks @wutaizeng!
...
### Features
- [#427](https://github.com/yevheniir/telegraf-fork/pull/427): zfs plugin: pool stats added. Thanks @allenpetersen!
- [#428](https://github.com/yevheniir/telegraf-fork/pull/428): Amazon Kinesis output. Thanks @jimmystewpot!
- [#449](https://github.com/yevheniir/telegraf-fork/pull/449): influxdb plugin, thanks @mark-rushakoff

### Bugfixes
- [#430](https://github.com/yevheniir/telegraf-fork/issues/430): Network statistics removed in elasticsearch 2.1. Thanks @jipperinbham!
- [#452](https://github.com/yevheniir/telegraf-fork/issues/452): Elasticsearch open file handles error. Thanks @jipperinbham!

## v0.2.4 [2015-12-08]

### Features
- [#412](https://github.com/yevheniir/telegraf-fork/pull/412): Additional memcached stats. Thanks @mgresser!
- [#410](https://github.com/yevheniir/telegraf-fork/pull/410): Additional redis metrics. Thanks @vlaadbrain!
- [#414](https://github.com/yevheniir/telegraf-fork/issues/414): Jolokia plugin auth parameters
- [#415](https://github.com/yevheniir/telegraf-fork/issues/415): memcached plugin: support unix sockets
- [#418](https://github.com/yevheniir/telegraf-fork/pull/418): memcached plugin additional unit tests.
- [#408](https://github.com/yevheniir/telegraf-fork/pull/408): MailChimp plugin.
- [#382](https://github.com/yevheniir/telegraf-fork/pull/382): Add system wide network protocol stats to `net` plugin.
- [#401](https://github.com/yevheniir/telegraf-fork/pull/401): Support pass/drop/tagpass/tagdrop for outputs. Thanks @oldmantaiter!

### Bugfixes
- [#405](https://github.com/yevheniir/telegraf-fork/issues/405): Prometheus output cardinality issue
- [#388](https://github.com/yevheniir/telegraf-fork/issues/388): Fix collection hangup when cpu times decrement.
...
### Features
- [#379](https://github.com/yevheniir/telegraf-fork/pull/379): Riemann output, thanks @allenj!
- [#375](https://github.com/yevheniir/telegraf-fork/pull/375): kafka_consumer service plugin.
- [#392](https://github.com/yevheniir/telegraf-fork/pull/392): Procstat plugin can now accept pgrep -f pattern, thanks @ecarreras!
- [#383](https://github.com/yevheniir/telegraf-fork/pull/383): Specify plugins as a list.
- [#354](https://github.com/yevheniir/telegraf-fork/pull/354): Add ability to specify multiple metrics in one statsd line. Thanks @MerlinDMC!

### Bugfixes
- [#371](https://github.com/yevheniir/telegraf-fork/issues/371): Kafka consumer plugin not functioning.
- [#389](https://github.com/yevheniir/telegraf-fork/issues/389): NaN value panic
...
### Bugfixes
- [#377](https://github.com/yevheniir/telegraf-fork/pull/377): Fix for duplicate slices in inputs.
...
### Features
- [#325](https://github.com/yevheniir/telegraf-fork/pull/325): NSQ output. Thanks @jrxFive!
- [#318](https://github.com/yevheniir/telegraf-fork/pull/318): Prometheus output. Thanks @oldmantaiter!
- [#338](https://github.com/yevheniir/telegraf-fork/pull/338): Restart Telegraf on package upgrade. Thanks @linsomniac!
- [#337](https://github.com/yevheniir/telegraf-fork/pull/337): Jolokia plugin, thanks @saiello!
- [#350](https://github.com/yevheniir/telegraf-fork/pull/350): Amon output.
- [#365](https://github.com/yevheniir/telegraf-fork/pull/365): Twemproxy plugin by @codeb2cc
- [#317](https://github.com/yevheniir/telegraf-fork/issues/317): ZFS plugin, thanks @cornerot!
- [#364](https://github.com/yevheniir/telegraf-fork/pull/364): Support InfluxDB UDP output.
- [#370](https://github.com/yevheniir/telegraf-fork/pull/370): Support specifying multiple outputs, as lists.
- [#372](https://github.com/yevheniir/telegraf-fork/pull/372): Remove gosigar and update go-dockerclient for FreeBSD support. Thanks @MerlinDMC!

### Bugfixes
- [#331](https://github.com/yevheniir/telegraf-fork/pull/331): Dont overwrite host tag in redis plugin.
- [#336](https://github.com/yevheniir/telegraf-fork/pull/336): Mongodb plugin should take 2 measurements.
- [#351](https://github.com/yevheniir/telegraf-fork/issues/317): Fix continual "CREATE DATABASE" in writes
- [#360](https://github.com/yevheniir/telegraf-fork/pull/360): Apply prefix before ShouldPass check. Thanks @sotfo!
...
### Features
- [#205](https://github.com/yevheniir/telegraf-fork/issues/205): Include per-db redis keyspace info
- [#226](https://github.com/yevheniir/telegraf-fork/pull/226): Add timestamps to points in Kafka/AMQP outputs. Thanks @ekini
- [#90](https://github.com/yevheniir/telegraf-fork/issues/90): Add Docker labels to tags in docker plugin
- [#223](https://github.com/yevheniir/telegraf-fork/pull/223): Add port tag to nginx plugin. Thanks @neezgee!
- [#227](https://github.com/yevheniir/telegraf-fork/pull/227): Add command intervals to exec plugin. Thanks @jpalay!
- [#241](https://github.com/yevheniir/telegraf-fork/pull/241): MQTT Output. Thanks @shirou!
...
- [#240](https://github.com/yevheniir/telegraf-fork/pull/240): procstat plugin, thanks @ranjib!
- [#244](https://github.com/yevheniir/telegraf-fork/pull/244): netstat plugin, thanks @shirou!
- [#262](https://github.com/yevheniir/telegraf-fork/pull/262): zookeeper plugin, thanks @jrxFive!
- [#237](https://github.com/yevheniir/telegraf-fork/pull/237): statsd service plugin, thanks @sparrc
- [#273](https://github.com/yevheniir/telegraf-fork/pull/273): puppet agent plugin, thats @jrxFive!
- [#280](https://github.com/yevheniir/telegraf-fork/issues/280): Use InfluxDB client v2.
- [#281](https://github.com/yevheniir/telegraf-fork/issues/281): Eliminate need to deep copy Batch Points.
- [#286](https://github.com/yevheniir/telegraf-fork/issues/286): bcache plugin, thanks @cornerot!
- [#287](https://github.com/yevheniir/telegraf-fork/issues/287): Batch AMQP output, thanks @ekini!
- [#301](https://github.com/yevheniir/telegraf-fork/issues/301): Collect on even intervals
- [#298](https://github.com/yevheniir/telegraf-fork/pull/298): Support retrying output writes
- [#300](https://github.com/yevheniir/telegraf-fork/issues/300): aerospike plugin. Thanks @oldmantaiter!
- [#322](https://github.com/yevheniir/telegraf-fork/issues/322): Librato output. Thanks @jipperinbham!

### Bugfixes
- [#228](https://github.com/yevheniir/telegraf-fork/pull/228): New version of package will replace old one. Thanks @ekini!
- [#232](https://github.com/yevheniir/telegraf-fork/pull/232): Fix bashism run during deb package installation. Thanks @yankcrime!
- [#261](https://github.com/yevheniir/telegraf-fork/issues/260): RabbitMQ panics if wrong credentials given. Thanks @ekini!
- [#245](https://github.com/yevheniir/telegraf-fork/issues/245): Document Exec plugin example. Thanks @ekini!
- [#264](https://github.com/yevheniir/telegraf-fork/issues/264): logrotate config file fixes. Thanks @linsomniac!
- [#290](https://github.com/yevheniir/telegraf-fork/issues/290): Fix some plugins sending their values as strings.
- [#289](https://github.com/yevheniir/telegraf-fork/issues/289): Fix accumulator panic on nil tags.
- [#302](https://github.com/yevheniir/telegraf-fork/issues/302): Fix `[tags]` getting applied, thanks @gotyaoi!
...
### Features
- [#143](https://github.com/yevheniir/telegraf-fork/issues/143): InfluxDB clustering support
- [#181](https://github.com/yevheniir/telegraf-fork/issues/181): Makefile GOBIN support. Thanks @Vye!
- [#203](https://github.com/yevheniir/telegraf-fork/pull/200): AMQP output. Thanks @ekini!
- [#182](https://github.com/yevheniir/telegraf-fork/pull/182): OpenTSDB output. Thanks @rplessl!
- [#187](https://github.com/yevheniir/telegraf-fork/pull/187): Retry output sink connections on startup.
- [#220](https://github.com/yevheniir/telegraf-fork/pull/220): Add port tag to apache plugin. Thanks @neezgee!
- [#217](https://github.com/yevheniir/telegraf-fork/pull/217): Add filtering for output sinks
and filtering when specifying a config file.

### Bugfixes
- [#170](https://github.com/yevheniir/telegraf-fork/issues/170): Systemd support
- [#175](https://github.com/yevheniir/telegraf-fork/issues/175): Set write precision before gathering metrics
- [#178](https://github.com/yevheniir/telegraf-fork/issues/178): redis plugin, multiple server thread hang bug
- Fix net plugin on darwin
- [#84](https://github.com/yevheniir/telegraf-fork/issues/84): Fix docker plugin on CentOS. Thanks @neezgee!
- [#189](https://github.com/yevheniir/telegraf-fork/pull/189): Fix mem_used_perc. Thanks @mced!
- [#192](https://github.com/yevheniir/telegraf-fork/issues/192): Increase compatibility of postgresql plugin. Now supports versions 8.1+
- [#203](https://github.com/yevheniir/telegraf-fork/issues/203): EL5 rpm support. Thanks @ekini!
- [#206](https://github.com/yevheniir/telegraf-fork/issues/206): CPU steal/guest values wrong on linux.
- [#212](https://github.com/yevheniir/telegraf-fork/issues/212): Add hashbang to postinstall script. Thanks @ekini!
- [#212](https://github.com/yevheniir/telegraf-fork/issues/212): Fix makefile warning. Thanks @ekini!
...
### Features
- [#150](https://github.com/yevheniir/telegraf-fork/pull/150): Add Host Uptime metric to system plugin
- [#158](https://github.com/yevheniir/telegraf-fork/pull/158): Apache Plugin. Thanks @KPACHbIuLLIAnO4
- [#159](https://github.com/yevheniir/telegraf-fork/pull/159): Use second precision for InfluxDB writes
- [#165](https://github.com/yevheniir/telegraf-fork/pull/165): Add additional metrics to mysql plugin. Thanks @nickscript0
- [#162](https://github.com/yevheniir/telegraf-fork/pull/162): Write UTC by default, provide option
- [#166](https://github.com/yevheniir/telegraf-fork/pull/166): Upload binaries to S3
- [#169](https://github.com/yevheniir/telegraf-fork/pull/169): Ping plugin
...
### Features
- [#38](https://github.com/yevheniir/telegraf-fork/pull/38): Kafka output producer.
- [#133](https://github.com/yevheniir/telegraf-fork/pull/133): Add plugin.Gather error logging. Thanks @nickscript0!
- [#136](https://github.com/yevheniir/telegraf-fork/issues/136): Add a -usage flag for printing usage of a single plugin.
- [#137](https://github.com/yevheniir/telegraf-fork/issues/137): Memcached: fix when a value contains a space
- [#138](https://github.com/yevheniir/telegraf-fork/issues/138): MySQL server address tag.
- [#142](https://github.com/yevheniir/telegraf-fork/pull/142): Add Description and SampleConfig funcs to output interface
- Indent the toml config file for readability

### Bugfixes
- [#128](https://github.com/yevheniir/telegraf-fork/issues/128): system_load measurement missing.
- [#129](https://github.com/yevheniir/telegraf-fork/issues/129): Latest pkg url fix.
- [#131](https://github.com/yevheniir/telegraf-fork/issues/131): Fix memory reporting on linux & darwin. Thanks @subhachandrachandra!
- [#140](https://github.com/yevheniir/telegraf-fork/issues/140): Memory plugin prec->perc typo fix. Thanks @brunoqc!

## v0.1.6 [2015-08-20]

### Features
- [#112](https://github.com/yevheniir/telegraf-fork/pull/112): Datadog output. Thanks @jipperinbham!
- [#116](https://github.com/yevheniir/telegraf-fork/pull/116): Use godep to vendor all dependencies
- [#120](https://github.com/yevheniir/telegraf-fork/pull/120): Httpjson plugin. Thanks @jpalay & @alvaromorales!

### Bugfixes
- [#113](https://github.com/yevheniir/telegraf-fork/issues/113): Update README with Telegraf/InfluxDB compatibility
- [#118](https://github.com/yevheniir/telegraf-fork/pull/118): Fix for disk usage stats in Windows. Thanks @srfraser!
- [#122](https://github.com/yevheniir/telegraf-fork/issues/122): Fix for DiskUsage segv fault. Thanks @srfraser!
- [#126](https://github.com/yevheniir/telegraf-fork/issues/126): Nginx plugin not catching net.SplitHostPort error

## v0.1.5 [2015-08-13]

### Features
- [#54](https://github.com/yevheniir/telegraf-fork/pull/54): MongoDB plugin. Thanks @jipperinbham!
- [#55](https://github.com/yevheniir/telegraf-fork/pull/55): Elasticsearch plugin. Thanks @brocaar!
- [#71](https://github.com/yevheniir/telegraf-fork/pull/71): HAProxy plugin. Thanks @kureikain!
- [#72](https://github.com/yevheniir/telegraf-fork/pull/72): Adding TokuDB metrics to MySQL. Thanks vadimtk!
- [#73](https://github.com/yevheniir/telegraf-fork/pull/73): RabbitMQ plugin. Thanks @ianunruh!
- [#77](https://github.com/yevheniir/telegraf-fork/issues/77): Automatically create database.
- [#79](https://github.com/yevheniir/telegraf-fork/pull/56): Nginx plugin. Thanks @codeb2cc!
- [#86](https://github.com/yevheniir/telegraf-fork/pull/86): Lustre2 plugin. Thanks srfraser!
- [#91](https://github.com/yevheniir/telegraf-fork/pull/91): Unit testing
- [#92](https://github.com/yevheniir/telegraf-fork/pull/92): Exec plugin. Thanks @alvaromorales!
- [#98](https://github.com/yevheniir/telegraf-fork/pull/98): LeoFS plugin. Thanks @mocchira!
- [#103](https://github.com/yevheniir/telegraf-fork/pull/103): Filter by metric tags. Thanks @srfraser!
- [#106](https://github.com/yevheniir/telegraf-fork/pull/106): Options to filter plugins on startup. Thanks @zepouet!
- [#107](https://github.com/yevheniir/telegraf-fork/pull/107): Multiple outputs beyong influxdb. Thanks @jipperinbham!
- [#108](https://github.com/yevheniir/telegraf-fork/issues/108): Support setting per-CPU and total-CPU gathering.
- [#111](https://github.com/yevheniir/telegraf-fork/pull/111): Report CPU Usage in cpu plugin. Thanks @jpalay!

### Bugfixes
- [#85](https://github.com/yevheniir/telegraf-fork/pull/85): Fix GetLocalHost testutil function for mac users
- [#89](https://github.com/yevheniir/telegraf-fork/pull/89): go fmt fixes
- [#94](https://github.com/yevheniir/telegraf-fork/pull/94): Fix for issue #93, explicitly call sarama.v1 -> sarama
- [#101](https://github.com/yevheniir/telegraf-fork/issues/101): switch back from master branch if building locally
- [#99](https://github.com/yevheniir/telegraf-fork/issues/99): update integer output to new InfluxDB line protocol format

## v0.1.4 [2015-07-09]

### Features
- [#56](https://github.com/yevheniir/telegraf-fork/pull/56): Update README for Kafka plugin. Thanks @EmilS!

### Bugfixes
- [#50](https://github.com/yevheniir/telegraf-fork/pull/50): Fix init.sh script to use telegraf directory. Thanks @jseriff!
- [#52](https://github.com/yevheniir/telegraf-fork/pull/52): Update CHANGELOG to reference updated directory. Thanks @benfb!

## v0.1.3 [2015-07-05]

### Features
- [#35](https://github.com/yevheniir/telegraf-fork/pull/35): Add Kafka plugin. Thanks @EmilS!
- [#47](https://github.com/yevheniir/telegraf-fork/pull/47): Add RethinkDB plugin. Thanks @jipperinbham!

### Bugfixes
- [#45](https://github.com/yevheniir/telegraf-fork/pull/45): Skip disk tags that don't have a value. Thanks @jhofeditz!
- [#43](https://github.com/yevheniir/telegraf-fork/pull/43): Fix bug in MySQL plugin. Thanks @marcosnils!

## v0.1.2 [2015-07-01]

### Features
- [#12](https://github.com/yevheniir/telegraf-fork/pull/12): Add Linux/ARM to the list of built binaries. Thanks @voxxit!
- [#14](https://github.com/yevheniir/telegraf-fork/pull/14): Clarify the S3 buckets that Telegraf is pushed to.
- [#16](https://github.com/yevheniir/telegraf-fork/pull/16): Convert Redis to use URI, support Redis AUTH. Thanks @jipperinbham!
- [#21](https://github.com/yevheniir/telegraf-fork/pull/21): Add memcached plugin. Thanks @Yukki!

### Bugfixes
- [#13](https://github.com/yevheniir/telegraf-fork/pull/13): Fix the packaging script.
- [#19](https://github.com/yevheniir/telegraf-fork/pull/19): Add host name to metric tags. Thanks @sherifzain!
- [#20](https://github.com/yevheniir/telegraf-fork/pull/20): Fix race condition with accumulator mutex. Thanks @nkatsaros!
- [#23](https://github.com/yevheniir/telegraf-fork/pull/23): Change name of folder for packages. Thanks @colinrymer!
- [#32](https://github.com/yevheniir/telegraf-fork/pull/32): Fix spelling of memoory -> memory. Thanks @tylernisonoff!
